(function () {
  ...
  function makeBrazil$1(parent, dispatcher, data) {
    parent.html(null);
    makeHeader(parent, 'Brasil');
    parent.append('p').html('[trabajo en curso... mostrar un mensaje - buscar o click]');
  }
  ...
  function makeCocktail(parent, dispatcher, mun, data) {
    ...
    parent.append('p').html('<strong>Población:</strong> ' + (+mun.properties.population).toLocaleString('pt-BR')); // map1Number should always be present - NaN if no tests
  ...
  function makeLimits(parent, dispatcher, mun, data) {
    parent.html(null);
    makeHeader(parent, mun.properties.name, mun.properties.fuName);
    parent.append('p').html('<strong>Población:</strong> ' + (+mun.properties.population).toLocaleString('pt-BR')); // map2Category should always be present
