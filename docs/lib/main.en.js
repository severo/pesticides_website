(function () {
        ...
        if (subst[0].max && subst[0].max > DETECTED_VALUE) {
          ul.append('li').text(
            'Max detected concentration: ' +
              subst[0].max.toLocaleString('en-US') +
              ' μg/L'
          );
        }
      }
  ...
  */
  ...
  var cfg$2 = {
    cocktail: {
      ...
      labels: {
        CAT_1: 'No agrotoxic',
        CAT_2: '1 to 13 agrotoxics',
        CAT_3: '14 to 26 agrotoxics',
        CAT_4: 'All 27 agrotoxics',
        NO_TEST: 'no data'
      }
    },
    limits: {
  ...
  */
  ...
  function createLegendCocktail(parent) {
    ...
    label.append('text').attr('y', -cfg$2.cocktail.dim.titleOffset).attr('font-weight', 'bold').text('Number of pesticides detected in');
    label.append('text').attr('y', -cfg$2.cocktail.dim.subtitleOffset).attr('font-weight', 'bold').text('drinking water');
  }
  ...
  function createLegendLimits(parent) {
    ...
    label.append('text').attr('y', -cfg$2.limits.dim.titleOffset).attr('font-weight', 'bold').text('Pesticides detected above legal limits');
    label.append('text').attr('y', -cfg$2.limits.dim.subtitleOffset).attr('font-weight', 'bold').text('in drinking water');
  }
