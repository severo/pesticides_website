  ...
  */
  ...
  function create$1(view) {
    return function (state, content, dispatcher) {
      ...
      var path = createPath(); // Add sub-elements
      ...
      createFuFrontiers(map, path, state.data); // TODO: evaluate if the function should return a value or not
  ...
  function appendDebug(dispatcher, parent) {
    ...
    dispatcher.on('number-hover', function (data) {
      return log(data, pre);
    });
  }
