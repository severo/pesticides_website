(function () {
  ...
  function makeTubesCocktail(parent, substances, titleHtml, tubeClass) {
    ...
    text.append('tspan').attr('x', '0').attr('dy', '0').text(function (sub) {
      return sub.numDetections + ' detecciones';
    });
    text.append('tspan').attr('x', '0').attr('dy', '1.2em').text(function (sub) {
      return 'en ' + sub.numTests + ' tests';
    });
  }
  ...
  */
  ...
  function makeCocktailToOtherViews(parent, dispatcher, state) {
    ...
    par.append('span').text('Descubra cuántas sustancias fueron ');
    par.append('a').attr('href', '#').text('detectadas por encima de los límites legales').on('click', function () {
  ...
  function createLegendCocktail(parent) {
    ...
    label
      ...
      .text('Número de pesticidas detectados');

    label
      .append('text')
      .attr('y', -cfg.cocktail.dim.titleOffsetLine2)
      .attr('font-weight', 'bold')
      .text('en el agua potable');
    ...
    label
      ...
      .text('(claro: 0, oscuro: 27 pesticidas diferentes)');
  ...
  */
  ...
  function createLegendCocktail(parent) {
    ...
    label.append('text').attr('y', -cfg$2.cocktail.dim.titleOffset).attr('font-weight', 'bold').text('Número de pesticidas detectados');
    label.append('text').attr('y', -cfg$2.cocktail.dim.subtitleOffset).attr('font-weight', 'bold').text('en el agua potable');
  }
  ...
  function createLegendLimits(parent) {
    ...
    label.append('text').attr('y', -cfg$2.limits.dim.titleOffset).attr('font-weight', 'bold').text('Pesticidas detectados por encima');
    label.append('text').attr('y', -cfg$2.limits.dim.subtitleOffset).attr('font-weight', 'bold').text('de los límites legales en el agua potable');
  }
  ...
  function cocktailLabel(mun) {
    return Number.isInteger(mun.properties.map1Number) ? mun.properties.map1Number + ' pesticida(s) encontrado(s) en el agua potable.' : 'Sin medición.';
  }
